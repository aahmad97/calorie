...
// Import routes
const authRoutes = require('./Routes/routeauthentication');
const nutritionRoutes = require('./Routes/nutritionRoute');
const mealPlannerRoutes = require('./Routes/plannedmealsRoute');

// Mount routes
app.use('/api/users', routeauthentication); // Authentication endpoints 
app.use('/api/nutrition', nutritionRoute); // Nutrition calculation endpoints
app.use('/api', plannedmealsRoute); // Meal planner end point for generating meal plans
